        ...
        <div className="container my-5">
            <div className="row p-4 align-items-center border shadow-lg">
                <div className="col-lg-7 p-3">
                    ...
                    <div className="d-grid gap-2 jusity-content-md-start mb-4 mb-lg-3">
                    { authState?.isAuthenticated ?
                            <Link type='button' className='btn main-color btn-lg px-4 me-md-2 fw-bold text-white' to='/search'>Library Services</Link>
                            :
